        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>All Units</h4>
                    <p class="mb-0">View and manage all units or products available in your inventory.
                    </p>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="d-grid gap-4 justify-content-between">
                            ...
                            <a href="{{ route('admin.units.create') }}" class="btn btn-sm btn-success text-white">Add
                                Unit</a>
                        </div>
                    </div>
                    <div class="card-body">
