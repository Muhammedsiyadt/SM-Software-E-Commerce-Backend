                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="d-row gap-4 justify-content-between">
                            ...
                            <a href="{{ route('admin.brands.create') }}" class="btn btn-sm btn-success text-white">Add
                                Brand</a>
                        </div>
                    </div>
                    <div class="card-body">
        ...
        $(function() {
                ...
                columnDefs: [{
...

                    {
                        ...
                        render: function(data, type, row, meta) {
                            var imageUrl = (typeof data !== 'undefined') ?
                                "{{ asset('storage/uploads/brands/') }}/" + data : '';
           ...
           <label class="custom-control-label" for="statusSwitch-${row.id}"></label>
...

                    {
                        targets: 5,
                        render: function(data, type, row, meta) {
                            var editUrl = "{{ route('admin.brands.edit', ':id') }}".replace(':id',
                                row.id);
                            var deleteUrl = "{{ route('admin.brands.destroy', ':id') }}".replace(
                                ':id', row.id);
